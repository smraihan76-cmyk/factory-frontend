    ...
    return (
      <div className="min-h-screen bg-stone-100 flex justify-center">
        <div className="w-full max-w-sm bg-stone-100 min-h-screen relative pb-24 flex flex-col">
          ...
          <div className="bg-stone-800 text-white px-4 py-3 sticky top-0 z-10 flex items-center gap-3">
                    ...
                    <div key={t.id} className={`flex flex-col ${isOwn ? 'items-end' : 'items-start'} relative`}>
                      ...
                      <div
                        ...
                        className={`max-w-[80%] rounded-2xl px-4 py-2.5 select-none cursor-pointer ${
                          isOwn ? 'bg-stone-700 text-white rounded-tr-sm' : 'bg-white text-gray-900 shadow-sm rounded-tl-sm'
                        }`}
                      >
                        {t.image_url && (
                      ...
                      {hasReactions && (
                        <div className="flex items-center gap-1 mt-1 bg-white rounded-full shadow-sm px-2 py-0.5 border border-gray-100">
