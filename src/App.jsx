...
function Dashboard({ currentUser, onLogout, onUpdateUser }) {
  ...
  const [manualSelectedShift, setManualSelectedShift] = useState(1);
    ...
    return (
      <div className="min-h-screen bg-stone-100 flex justify-center">
        <div className="w-full sm:max-w-sm bg-stone-100 min-h-screen pb-24">
          ...
          <div className="p-4">
            <p className="text-xs font-bold text-gray-500 uppercase mb-2">কোন শিফট?</p>
            <div className="flex gap-3 mb-5">
              <button
                onClick={() => setManualSelectedShift(1)}
                className={`flex-1 py-2.5 rounded-xl text-sm font-semibold border ${manualSelectedShift === 1 ? 'bg-red-950 text-white border-red-950' : 'border-gray-200 text-gray-600 bg-white'}`}
              >
                শিফট ১
              </button>
              <button
                onClick={() => setManualSelectedShift(2)}
                className={`flex-1 py-2.5 rounded-xl text-sm font-semibold border ${manualSelectedShift === 2 ? 'bg-red-950 text-white border-red-950' : 'border-gray-200 text-gray-600 bg-white'}`}
              >
                শিফট ২
              </button>
            </div>
