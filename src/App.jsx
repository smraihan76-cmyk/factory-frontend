...
function Dashboard({ currentUser, onLogout }) {
  ...
  const quickActions = [
    ...
    { icon: <CheckCircle2 size={24} className="text-yellow-700" />, bg: 'bg-yellow-100', label: 'মজুরী', onClick: openExpenseReport },
  ...
  return (
    <div className="min-h-screen bg-stone-100 flex justify-center">
      <div className={`w-full max-w-sm bg-stone-100 min-h-screen relative pb-20 ${(cashMemoStaff || showExpenseReport) ? 'print:hidden' : ''}`}>
        ...
        {/* Summary Card */}
        <div className="mx-4 -mt-10 bg-white rounded-2xl shadow-sm border-2 border-amber-200 p-5">
        ...
        <div className="flex gap-3 px-4 mt-3">
          {stats.map((s, i) => (
            <div key={i} onClick={s.onClick} className="flex-1 bg-white rounded-2xl p-3.5 shadow-sm border-2 border-amber-200 active:opacity-80 cursor-pointer">
          ...
          <div className="grid grid-cols-4 gap-3">
            {quickActions.map((a, i) => (
              <button key={i} onClick={a.onClick} className="flex flex-col items-center gap-2 active:opacity-70">
                <div className={`w-14 h-14 rounded-2xl ${a.bg} border-2 border-amber-200 flex items-center justify-center shadow-sm`}>
                  {a.icon}
                </div>
        ...
        <div className="px-4 mt-6">
          ...
          <button
            ...
            className="w-full bg-white rounded-2xl shadow-sm border-2 border-amber-200 p-4 flex items-center gap-3 active:opacity-80 text-left"
          >
        ...
        {/* Help banner */}
        <div className="mx-4 mt-6 bg-white rounded-2xl shadow-sm border-2 border-amber-200 p-4 flex items-center gap-3 active:bg-gray-50">
            ...
            <div className="w-full max-w-sm bg-white rounded-t-3xl print:rounded-none p-6 max-h-[85vh] print:max-h-none overflow-y-auto print:overflow-visible">
              ...
              {expenseReportLoading ? (
                ...
                <>
                  ...
                  {allExpenses.length === 0 && allStaffPayments.length === 0 && (
