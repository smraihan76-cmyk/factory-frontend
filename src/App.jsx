...
import {
  ...
  RefreshCw, CheckCircle2, CreditCard, UserPlus,
...
export default function App() {
  ...
  const quickActions = [
    { icon: <PlusCircle size={24} className="text-red-800" />, bg: 'bg-red-100', label: 'নতুন প্রোডাক্ট যোগ করুন' },
    { icon: <HardHat size={24} className="text-amber-700" />, bg: 'bg-amber-100', label: 'নতুন কারিগর যোগ করুন' },
    { icon: <Users size={24} className="text-red-800" />, bg: 'bg-red-100', label: 'কারিগর হিসাব' },
    { icon: <Wallet size={24} className="text-red-800" />, bg: 'bg-red-100', label: 'সেলারি' },
    { icon: <RefreshCw size={24} className="text-orange-700" />, bg: 'bg-orange-100', label: 'পার্টনার হিসাব' },
    { icon: <CheckCircle2 size={24} className="text-orange-700" />, bg: 'bg-orange-100', label: 'মজুরী' },
    { icon: <CreditCard size={24} className="text-red-800" />, bg: 'bg-red-100', label: 'ফান্ড/খরচ' },
    { icon: <UserPlus size={24} className="text-emerald-700" />, bg: 'bg-emerald-100', label: 'স্টাফ যোগ করুন' },
  ];
