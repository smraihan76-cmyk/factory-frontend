                ...
                <div className="flex flex-col gap-3">
                  {partners.map((p) => (
                    <button
                      ...
                      className="text-left bg-white rounded-2xl shadow-md border-2 border-gray-200 p-4 flex items-center gap-3 active:opacity-80"
                    >
                      {p.photo_url ? (
                        <img src={p.photo_url} alt="" className="w-11 h-11 rounded-full object-cover shrink-0" />
                      ) : (
                        <div className="w-11 h-11 rounded-full bg-red-900 text-white flex items-center justify-center font-bold shrink-0">
