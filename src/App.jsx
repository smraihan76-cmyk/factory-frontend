                      ...
                      <div className="mt-2 space-y-2">
                        {d.shift1?.attended && (
                          <div className="bg-sky-50 rounded-lg p-2.5 text-xs text-gray-600">
                            ...
                            <p>বের হয়েছে: {d.shift1.check_out ? new Date(d.shift1.check_out).toLocaleTimeString('bn-BD', { hour: '2-digit', minute: '2-digit' }) : '—'}</p>
                        ...
                        {d.shift2?.attended && (
                          <div className="bg-indigo-50 rounded-lg p-2.5 text-xs text-gray-600">
                            ...
                            <p>বের হয়েছে: {d.shift2.check_out ? new Date(d.shift2.check_out).toLocaleTimeString('bn-BD', { hour: '2-digit', minute: '2-digit' }) : '—'}</p>
