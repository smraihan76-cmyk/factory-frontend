...
const shareContentAsPDF = async (elementId, filename, title, onError) => {
  try {
        ...
        <div id="employee-cash-memo" className="w-full sm:max-w-sm bg-white min-h-screen p-6">
          <div className="flex items-center justify-between mb-4 print:hidden">
            ...
            <div className="flex items-center gap-2">
              <button
                onClick={() => shareContentAsPDF('employee-cash-memo', `cash-memo-${staffDetail?.name || 'staff'}`, 'ক্যাশ মেমো')}
      ...
      <div className="min-h-screen bg-stone-100 flex justify-center print:bg-white">
        <div id="dashboard-cash-memo" className="w-full sm:max-w-sm bg-white min-h-screen p-6">
          <div className="flex items-center justify-between mb-4 print:hidden">
            ...
            <div className="flex items-center gap-2">
              <button
                onClick={() => shareContentAsPDF('dashboard-cash-memo', `cash-memo-${cashMemoStaff?.name || 'staff'}`, 'ক্যাশ মেমো')}
                className="w-9 h-9 rounded-full bg-emerald-100 flex items-center justify-center"
              >
                <Share2 size={16} className="text-emerald-700" />
              </button>
      ...
      <div className="min-h-screen bg-stone-100 flex justify-center print:bg-white">
        <div id="expense-report-content" className="w-full sm:max-w-sm bg-white min-h-screen p-6">
          <div className="flex items-center justify-between mb-4 print:hidden">
            ...
            <div className="flex items-center gap-2">
              <button
                onClick={() => shareContentAsPDF('expense-report-content', 'khoroch-bistarito', 'খরচের বিস্তারিত')}
                className="w-9 h-9 rounded-full bg-emerald-100 flex items-center justify-center"
              >
                <Share2 size={16} className="text-emerald-700" />
              </button>
